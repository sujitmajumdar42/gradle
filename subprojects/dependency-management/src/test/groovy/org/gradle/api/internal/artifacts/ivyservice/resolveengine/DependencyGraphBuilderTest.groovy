...
class DependencyGraphBuilderTest extends Specification {
    ...
    def revision(String name, String revision = '1.0') {
        ...
        metaData.addConfiguration("default", "defaultConfig", [] as Set<String>, ["default"] as Set<String>, true, true, null, ConfigurationRole.FOR_RESOLUTION, new DefaultTaskDependency())
    ...
    def project(String name, String revision = '1.0', List<String> extraConfigs = []) {
        ...
        extraConfigs.each { String config ->
            metaData.addConfiguration(config, "${config}Config", ["default"] as Set<String>, ["default", config] as Set<String>, true, true, null, ConfigurationRole.FOR_RESOLUTION, new DefaultTaskDependency())
        }
        metaData.addArtifacts("default", [new DefaultPublishArtifact("art1", "zip", "art", null, new Date(), new File("art1.zip"))])
        return metaData
    }
