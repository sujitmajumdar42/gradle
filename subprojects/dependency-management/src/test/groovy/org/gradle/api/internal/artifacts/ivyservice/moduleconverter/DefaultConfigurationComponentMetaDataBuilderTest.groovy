...
class DefaultConfigurationComponentMetaDataBuilderTest extends Specification {
    ...
    def "adds artifacts from each configuration"() {
        ...
        then:
        _ * metaData.addConfiguration("config1", '', emptySet, emptySet, false, false, [:], _, _ as TaskDependency)
        _ * metaData.addConfiguration("config2", '', emptySet, emptySet, false, false, [:], _, _ as TaskDependency)
