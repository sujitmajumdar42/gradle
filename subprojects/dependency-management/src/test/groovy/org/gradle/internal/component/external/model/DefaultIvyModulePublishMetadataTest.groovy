...
class DefaultIvyModulePublishMetadataTest extends Specification {
    ...
    def "can add configuration"() {
        when:
        metadata.addConfiguration("configName", "configDescription", ["one", "two", "three"] as Set, ["one", "two", "three", "configName"] as Set, true, true, null, ConfigurationRole.FOR_PUBLISHING_ONLY, null)
